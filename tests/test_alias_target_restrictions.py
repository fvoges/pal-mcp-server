...
class TestAliasTargetRestrictions:
    ...
    def test_restriction_policy_allows_alias_when_target_allowed(self):
        ...
        Note: 'mini' is now an alias for 'gpt-5.4-mini', not 'o4-mini'.
        """
    ...
    @patch.dict(os.environ, {"GOOGLE_ALLOWED_MODELS": "gemini-3.8-flash"})  # Allow target
    ...
    @patch.dict(os.environ, {"OPENAI_ALLOWED_MODELS": "mini,gpt-5.4-mini,o4-mini,o4mini"})
    ...
    def test_service_alias_allows_canonical_gemini(self):
        ...
        assert service.is_allowed(ProviderType.GOOGLE, "gemini-3.8-flash")
        assert provider.validate_model_name("gemini-3.8-flash")
